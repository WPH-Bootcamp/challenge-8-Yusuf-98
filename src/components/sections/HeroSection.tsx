...
function HeroSection() {
  ...
  return (
    <div
      className='flex flex-col mt-21 pt-12.5 px-4 
  ...
  relative overflow-hidden'
    >
      ...
      <img
        ...
        className='w-[99%] mx-auto absolute md:w-[58dvw] lg:w-[51.5dvw] h-auto right-1 top-71.5 lg:-top-50 mt-12 mb-12 md:-top-25 lg:mt-29'
      />
    </div>
  );
}

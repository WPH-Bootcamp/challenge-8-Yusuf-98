...
function PortfolioCard({ id, category, label, image, alt }: PortfolioProps) {
  return (
    <div className='group gap-3 max-w-93.25 h-auto cursor-pointer'>
      ...
      <div className='flex flex-col items-start w-full'>
        ...
        <p className='font-bold text-size-md md:text-size-xl text-neutral-25 transition-colors duration-300 group-hover:text-neutral-25/70'>
          {label}
        </p>
      </div>
    </div>
